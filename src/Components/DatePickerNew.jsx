...
const DatePickerNew = ({ formik, name, className, placeholder }) => {
    ...
    return (
        <div className="form-date-part col s4 input-field" >
            ...
            <FastField disabled className={className}
                type="text" name={name}
            />
            </span>
            {
                ...
                <div className='col s1 icon-date'>
                    <i className='fa fa-check' onClick={handleSetInputDate}></i>
                </div>
            </div>
                ) : null
            }
